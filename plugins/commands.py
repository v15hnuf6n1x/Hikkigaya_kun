...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🧩 𝖲𝗎𝗉𝗉𝗈𝗋𝗍 𝖦𝗋𝗈𝗎𝗉', url=f"https://t.me/Mr_V_bots")
                ],[
    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('😎 ALPHER 😎', url=f"https://t.me/a1pher") ] ] ),
            )
        return
        ...
        for msg in msgs:
            ...
            try:
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('😎 ALPHER 😎', url=f"https://t.me/Mr_V_bots") ] ] ),
    ...
    if not files_:
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                protect_content=True if pre == 'filep' else False,
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('😎 ALPHER 😎', url="https://t.me/Mr_V_bots") ] ] ),
            )
            filetype = msg.media
            ...
            pass
        return await message.reply('<b><i>There Is No such file exist.</b></i>')
    files = files_[0]
...
async def settings(client, message):
    ...
    if chat_type == enums.ChatType.PRIVATE:
        ...
        if grpid is not None:
            ...
            await message.reply_text("I'm Still not connected to any groups!", quote=True)
            return
...
async def send_msg(bot, message):
    if message.reply_to_message:
        ...
        await message.reply_text("<b>Error 𝖢𝗈𝗆𝗆𝖺𝗇𝖽 𝖨𝗇𝖼𝗈𝗆𝗉𝗅𝖾𝗍𝖾 !</b>")
